var mapIdValue = document.getElementById("mapIdValue");
var chosenSvgPath;

console.log(mapIdValue.value);
...
$('path').click(function(e){
    if(chosenSvgPath){
        chosenSvgPath.removeClass( "chosenSvgPath");
        mapIdValue.value = "";
        chosenSvgPath.css('fill','rgba(0,0,0,0.5)');    
        
        if(chosenSvgPath.attr('id').toUpperCase() === $(this).attr('id').toUpperCase()){  
            return;
        }
    }
 
    chosenSvgPath = $(this);
    chosenSvgPath.addClass( "chosenSvgPath" );
...
$('path').each(function() {
  ...
  for (var j = 0; j < idAarr2.length; j++) {
    ...
    if(regId == mapIdValue.value){
        chosenSvgPath = $(this);
        chosenSvgPath.addClass( "chosenSvgPath" );

        $(chosenSvgPath).css('fill','#357DFD');
    }
  }
